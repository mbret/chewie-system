...
class Module{
    ...
    initRoutes(app){
        ...
        app.get('/auth/google', function(req, res){
            ...
            var oauth2Client = new OAuth2(MyBuddy.config.externalServices.google.auth.clientId, MyBuddy.config.externalServices.google.auth.clientSecret, 'https://localhost:3000/google/callback');
