...
class Module{
    ...
    _initRoutes(app){
        ...
        // call screens
        var screensRoutes = [require(path.resolve(__dirname, 'public/app/screens/default/server/routes'))];
        screensRoutes.forEach(function(routes) {
            routes.call(self, app, router);
        });
    }
