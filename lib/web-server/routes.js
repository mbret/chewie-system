...
module.exports = function(app, router){
    ...
    /**
     * This route is used to serve screens.
     *
     * Screens are independant in order to get full capabilities
     * but they may use some helpers.
     */
    router.get("/screens/:name", function(req, res) {
        var view = path.resolve(__dirname, "public/app/screens/" + req.params.name + "/index");
