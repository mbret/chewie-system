(function(){
    ...
    angular
         ...
         */
        .controller("CreateScenariosController", function ($scope, $uibModal, apiService, auth, util, _) {
         ...
         * Add a new item.
         */
        .controller("CreateScenariosNewItemController", function($scope, $uibModalInstance, _, id, $uibModal, elements) {
