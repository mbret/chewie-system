(function(){
    ...
    angular
        ...
        .controller('PreferencesController', function($rootScope, $scope, APP_CONFIG, userService, notificationService, apiService, util, auth){

            $scope.formData = {};

            $rootScope.$on('auth:user:updated', function(){
                console.log('new user', auth.getUser());
            });
