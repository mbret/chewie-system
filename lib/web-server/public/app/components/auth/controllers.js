(function(){
    ...
    angular
        ...
        .controller('SigninController', function($scope, APP_CONFIG, apiService, notificationService, authenticationService, $timeout, $state, user){
            //$timeout(function(){
                authenticationService.login('admin', 'admin').then(function(){
                    notificationService.success('Logged in!');
                    console.log($state, $state.href());
