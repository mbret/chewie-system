(function(){
    ...
    var module = angular
        ...
        .controller('SigninController', function($rootScope, $scope, APP_CONFIG, apiService, notificationService, authenticationService, $timeout, $state, user, selectedProfile){
            ...
            $scope.login = function() {
                authenticationService.login(selectedProfile, $scope.formData.password)
                    .then(function(){
