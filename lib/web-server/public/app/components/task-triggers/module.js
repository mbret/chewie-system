    ...
    .config(function($stateProvider) {
        ...
        $stateProvider
            ...
            .state('dashboard.taskTriggers', {
                ...
                templateUrl: '/app/components/task-triggers/index.html'
            })

            .state('dashboard.taskTriggers.list', {
                url: '/list',
                controller: 'TaskTriggersController',
                templateUrl: '/app/components/task-triggers/list.html'
            })

            .state('dashboard.taskTriggers.config', {
                url: '/:id/configuration',
                templateUrl: '/app/components/task-triggers/config.html',
