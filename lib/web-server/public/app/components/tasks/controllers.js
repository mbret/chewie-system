(function(){
    ...
    angular
        ...
        .controller('TasksController', function($scope, $http, CONFIG, TASK_TYPE, notificationService, apiService, tasksService, _){
            ...
            apiService.get(CONFIG.apiUri + '/tasks', {}).then(function(data){
                $scope.tasks = data;
