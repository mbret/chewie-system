(function(){
    ...
    angular
        ...
        .controller('TasksController', function($scope, $http, APP_CONFIG, TASK_TYPE, notificationService, apiService, tasksService, _){
            ...
            apiService.get('/tasks', {}).then(function(data){
                ...
                console.log($scope.triggeredTasks, {'type': TASK_TYPE.trigger});
            });
