    ...
    .service('apiService', function($http, CONFIG, notificationService){
        ...
        var user = {
            getExternalStatus: function(){
                return get(CONFIG.apiUri + '/users/external-services-status');
            }
        };
        ...
        function postVoiceCommand(text){
            return this.post(CONFIG.apiUri + '/voice-command', { text: text, type: 'text' });
        }

        function getTaskTriggers(){
            return this.get(CONFIG.apiUri + '/task-triggers', {});
        }
