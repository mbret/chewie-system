...
angular.module('myBuddy')
    ...
    .directive('triggerOptions', function(CONFIG){
        return {
            scope: {
                configOptions: '=',
                options: '='
            ...
            // which markup this directive generates
            templateUrl: CONFIG.viewBaseUrl + '/directives/trigger-options.html',
    ...
    .directive('pluginOptions', function(CONFIG, $timeout){
        return {
            scope: {
                options: '='
            },
            ...
            // which markup this directive generates
            templateUrl: CONFIG.viewBaseUrl + '/directives/plugin-options.html',
