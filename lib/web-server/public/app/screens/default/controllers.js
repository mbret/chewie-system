(function(){
    ...
    angular.module('screens.default')
        ...
        .controller('ScreensDefaultIndexController', function($scope, APP_CONFIG, $state, _, screensService, notificationService, googleApi, apiService, util, auth, OAuth, $http){
