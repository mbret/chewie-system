...
class PluginHelper extends AbstractHelper{
    ...
    registerMessageAdapter(moduleName, module){
        ...
        //var res;
        //console.log('sdf');
        MyBuddy.messenger.registerMessageAdapter(moduleName, module, {}, function(err){
            //console.log('coucou');
            //res = err;
            self.plugin.messageAdapters.push(moduleName);

            logger.verbose('Plugin [%s] Registered new message adapter [%s]', self.plugin.name, moduleName);
        });
