...
var Server = (function (_super) {
    ...
    Server.prototype._startServer = function (cb) {
        ...
        if (this.system.config.sharedServerApiSSL.activate) {
            var privateKey = fs.readFileSync(this.system.config.sharedServerApiSSL.key, 'utf8');
            var certificate = fs.readFileSync(this.system.config.sharedServerApiSSL.cert, 'utf8');
