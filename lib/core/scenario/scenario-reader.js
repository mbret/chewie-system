...
var ScenarioReader = (function () {
    ...
    ScenarioReader.prototype.readScenario = function (scenario) {
        ...
        return this
            ...
            scenario.nodes.forEach(function (node) {
                ...
                var rtId = self.getRuntimeModuleKey(scenario.id, node.id, moduleId);
                var module = self.system.runtime.modules.get(rtId);
        ...
        function onTrigger(scenario, node) {
            ...
            node.nodes.forEach(function (subNode) {
                ...
                var runtimeModuleContainer = self.system.runtime.modules.get(self.getRuntimeModuleKey(scenario.id, subNode.id, moduleUniqueId));
    ...
    ScenarioReader.prototype.stopNode = function (scenario, node, options) {
        ...
        var module = this.system.runtime.modules.get(rtId);
