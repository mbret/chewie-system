(function(){
    ...
    angular
        ...
        .controller('CreateFormController', function($scope, $stateParams, pluginsService, $timeout, tasksService, $state){
            $scope.module = null;
            ...
            $timeout(function(){
                pluginsService.getTaskModule($stateParams.id)
            ...
            $scope.processForm = function(form) {
                if (!form.$valid) {
                    ...
                    tasksService.create($stateParams.id, task).then(function(){
