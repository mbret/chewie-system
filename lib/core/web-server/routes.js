...
module.exports = function(app, router){
    ...
    router.get('/configuration.js', function(req, res){
        ...
        var apiUrl = 'localhost:' + self.daemon.configHandler.getConfig().apiPort;

        // When outside of localhost, use real ip.
        if(req.ip !== '::1'){
            apiUrl = self.daemon.configHandler.getConfig().realIp + ':' + self.daemon.configHandler.getConfig().apiPort;
        }
