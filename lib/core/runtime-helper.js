...
var RuntimeHelper = (function () {
    function RuntimeHelper(system) {
    ...
    RuntimeHelper.prototype.initialize = function (cb) {
        return cb();
    };
    RuntimeHelper.prototype.hasActiveProfile = function () {
     ...
     * @param task
     */
    RuntimeHelper.prototype.executeTask = function (task) {
        var self = this;
    ...
    RuntimeHelper.prototype.stopTask = function (taskExecution) {
        // stop the execution
        taskExecution.stop();
    };
