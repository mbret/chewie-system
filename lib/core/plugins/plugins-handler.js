...
class PluginsHandler{
    ...
    getPluginAbsolutePath(pluginName) {
        return path.resolve(this.system.getConfig().system.synchronizedPluginsDir, pluginName);
    }
    ...
    loadPlugins(profileId, pluginsToLoad){
        ...
        return new Promise(function(resolve, reject) {
            async.each(pluginsToLoad, function(pluginToLoad, cb) {
                ...
                var pluginName = pluginToLoad.name;
    ...
    _registerPlugin(profileId, Plugin, pluginName, packageJson, pluginPackage, cb){
        ...
        this.system.apiService.findPlugin(profileId, pluginName)
            .then(function(data){
                ...
                var pluginTmpDir = path.resolve(self.system.getConfig().system.pluginsTmpDir, pluginName);
                var pluginDataDir = path.resolve(self.system.getConfig().system.pluginsDataDir, pluginName);
                ...
                Plugin.call(null, new PluginHelper(self.system, plugin), function(err) {
                    ...
                    async.each(pluginPackage.modules, function(moduleToRegister, cbModuleToRegister) {
                        ...
                        self.loadModule(profileId, plugin, moduleToRegister.name, moduleToRegister, module, cbModuleToRegister);
                    }, function(err) {
    ...
    loadModule(profileId, plugin, moduleName, modulePackageConfig, moduleClass, cb) {
        ...
        this.system.apiService.findModuleByName(profileId, plugin.id, moduleName)
            .then(function(module) {
                console.log(module, profileId, plugin.id, moduleName);
                if(!module) {
