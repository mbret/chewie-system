...
class PluginHelper extends AbstractHelper{
    ...
    registerModule(moduleName, module){
        ...
        // force synchronized
        sync.await(this.daemon.pluginsHandler.registerModule(this.plugin.id, moduleName, module, sync.defer()));
    }
    ...
    registerTrigger(moduleName, module){
        ...
        // force synchronized
        sync.await(MyBuddy.pluginsHandler.registerTrigger(this.plugin.id, moduleName, module, sync.defer()));
    }
}
