 ...
 * @returns {*}
 */
ApiHelper.prototype.findPluginsByUser = function(userId, pluginId) {
...
ApiHelper.prototype.findOrCreatePlugin = function(userId, pluginIdOrName, data) {
    var self = this;
    return this.findPluginsByUser(userId, pluginIdOrName)
 ...
 * @returns {*}
 */
ApiHelper.prototype.createTask = function(userId, data) {
    return this.post(util.format("/users/%s/tasks", userId), data)
        .then(function(response) {
            // We only should get 201 / 400
            if(response.statusCode !== 201) {
