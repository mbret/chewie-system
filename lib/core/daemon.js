    ...
    class Daemon extends EventEmitter{
        ...
        constructor(config){
            ...
            ConfigHandler.feedConfig(config, function(err){
                ...
                self.moduleHandler = new ModuleHandler.Class();
                ...
                // Contain an array of plugin object.
                self.plugins = [];
                ...
                function(done){
                    ...
                    self.database.getTasks(function(err, entries){
                        ...
                        _.forEach(tasks, function(task){
                            ...
                            self.moduleHandler.registerNewTask(new (Task.Task(self))(task.id, task.moduleId, task.pluginId, task.options, task.triggers), function(err){
                                if(err){
                                    logger.error(err);
                                }
                            });
