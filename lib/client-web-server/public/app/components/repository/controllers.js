(function(){
    ...
    angular
        ...
        .controller('RepositoryDetailController', function($scope, $rootScope, apiService, util, stateParams){
            $scope.plugin = [];

            apiService.get("/api/repositories/local/plugins/" + stateParams.name)
                .then(function(data) {
                    $scope.plugin = data;
                });
        });
