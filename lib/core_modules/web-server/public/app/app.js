...
angular.module('myBuddy')
    ...
    .controller('MessagesAdaptersController', function($scope, $http, CONFIG){
        $scope.adapters = [];
        $http.get(CONFIG.apiUri + '/messages-adapters', {}).then(function(response){
    ...
    .filter('interval', function(){
        ...
        return function(input) {
            return input ? 'Tout les ' + millisecondsToStr(input) : '';
        };
    })
