(function(){
    ...
    angular
         ...
         */
        .controller("CreateScenariosController", function ($scope, $uibModal, sharedApiService, auth, util, _, notificationService, apiService) {
            ...
            $scope.confirm = function(form) {
                ...
                if (form.$valid) {
                    sharedApiService.post(util.format("/users/%s/scenarios", auth.getUser().id), $scope.formData)
                        .then(function() {
            ...
            // retrieve the tasks
            apiService.get(util.format('/api/plugins/users/%s/modules', auth.getUser().id), { type: "task" })
                .then(function(data){
                    $scope.tasks = _.keyBy(data, "id");
                });

            // fetch triggers
            apiService.get(util.format('/api/plugins/users/%s/modules', auth.getUser().id), { type: "trigger" })
                .then(function(data){
         ...
         * Add a new item.
         */
        .controller("CreateScenariosNewItemController", function($scope, $uibModalInstance, _, id, $uibModal, elements, sharedApiService, authenticationService, util, apiService) {
            ...
            // fetch triggers
            apiService.get(util.format('/api/plugins/users/%s/modules', authenticationService.getUser().id), { type: "trigger" })
                .then(function(data) {
            ...
            // fetch tasks
            apiService.get(util.format('/api/plugins/users/%s/modules', authenticationService.getUser().id), { type: "task" })
                .then(function(data) {
