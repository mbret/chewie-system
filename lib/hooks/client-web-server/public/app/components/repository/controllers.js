(function(){
    ...
    angular
        ...
        .controller('LocalRepositoryDetailController', function($scope, $rootScope, sharedApiService, util, $stateParams, auth, apiService, $state){
            $scope.plugin = null;
        ...
        .controller('InstalledRepositoryDetailController', function($scope, $rootScope, sharedApiService, util, $stateParams, auth, apiService, $state){
            $scope.plugin = null;
            let name = $stateParams.name;
            $scope.ready = false;
