(function(){
    ...
    angular
        ...
        .controller('components.home.HomeController', function($scope, $http, toastr, APP_CONFIG, sharedApiService, auth, mySocket, notificationService, $interval, util, googleApi){
