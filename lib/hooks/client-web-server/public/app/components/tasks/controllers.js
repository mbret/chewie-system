(function(){
    ...
    angular
        ...
        .controller('TasksListController', function($rootScope, $scope, $http, APP_CONFIG, TASK_TYPE, notificationService, sharedApiService, tasksService, _, SweetAlert, auth, util, mySocket){
