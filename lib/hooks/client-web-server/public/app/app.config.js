...
module
        ...
        .constant('APP_CONFIG', {
            ...
            remoteApiUrl: SERVER_CONFIG.remoteApiUrl,
        ...
        .config(function($stateProvider, $urlRouterProvider, APP_CONFIG, componentsRoot) {
        ...
        .config(function (apiServiceProvider, APP_CONFIG) {
            apiServiceProvider.setApiUri(APP_CONFIG.apiUrl);
        })
