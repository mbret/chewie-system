...
module.exports = (function () {
    ...
    RuntimeProfileHook.prototype.initialize = function () {
        this.system
    ...
    RuntimeProfileHook.prototype.synchronizePlugins = function (plugins) {
        this.logger.verbose('Synchronizing plugins [%s]', _.map(plugins, "name"));
        return this.system.repository.synchronize(plugins);
    };
    RuntimeProfileHook.prototype.loadPlugins = function (plugins) {
    ...
    RuntimeProfileHook.prototype.unLoadPlugins = function (plugins) {
