...
class Daemon extends EventEmitter{
            ...
            function(done){
                ...
                self.database.getTasks(function(err, entries){
                    ...
                    _.forEach(tasks, function(task){
                        ...
                        self.moduleHandler._executeUserTask(Task.Build(task, task.type));
                    });
    ...
    _initialize(cb){
        ...
        async.series([
            ...
            function(done){
                logger.debug('loadPlugins');
                self.moduleHandler.loadPlugins(function(err, plugins){
            ...
            self.moduleHandler.startCoreModules.bind(null, self.coreModules),

            // Modules initialization
            Plugins.initializeModules.bind(null, self.userModules),

            // Initialize message adapters
            self.messenger.initializeAdapters.bind(self.messenger),
