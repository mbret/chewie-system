...
class Daemon extends CustomEventEmitter{
    ...
    constructor(configOverride){
        ...
        this.userHandler            = new user.UserHandler(this);
        ...
        require('./bootstrap')(self, logger, function(err){
            ...
            taskQueue.register('profile:started', function(cb){
                async.series([
                    ...
                    function(done){
                        self._processPostponedTasks(done);
                    }
    ...
    /**
     *  Return the current running profile or null.
     *  @return object|null
     */
    getCurrentProfile(){
        return this.userHandler.getProfile();
    }
