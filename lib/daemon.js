...
class Daemon extends EventEmitter{
    ...
    _initialize(cb){
        ...
        async.series([
            ...
            // Start api server
            function(done){
                var apiServer = new ApiServer(MyBuddy);
                apiServer.initialize(done);
            },

            // Start web server
            function(done){
                var webServer = new WebServer(MyBuddy);
                webServer.initialize(done);
            },
            ...
            // Start core module
            function(done){
                self.coreModulesHandler.startCoreModules(self.coreModulesNew, function(err){
