...
var reader_1 = require("./core/scenario/reader");
...
var Daemon = (function (_super) {
    ...
    function Daemon(configOverride) {
        ...
        this.scenarioReader = new reader_1.ScenarioReader(this);
    ...
    Daemon.prototype.getConfig = function () {
    ...
    Daemon.prototype._bootstrap = function (done) {
        var self = this;
     ...
     * @private
     */
    Daemon.prototype._attachProfileEventsTasks = function () {
        var self = this;
        ...
        taskQueue.register('profile:stop', function (cb) {
            ...
            async.map(tasksIds, function (id, cbTask) {
                ...
                async.parallel([
                    ...
                    function (cb2) {
                        var promises = [];
                        for (var _i = 0, _a = self.modules; _i < _a.length; _i++) {
                            var module_1 = _a[_i];
                            self.logger.verbose("Destroying module %s", module_1.name);
     ...
     * @param file
     */
    Daemon.prototype.playSystemSound = function (file) {
