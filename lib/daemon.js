            ...
            if(profileToLoad) {
                self.runtimeHelper.profile.startProfile(profileToLoad)
                    .then(function(){
                        ...
                        //return self.runtimeHelper.profile.stopProfile();
                    })
                    ...
                    async.series([
                        ...
                        function(done){
                            async.parallel([
                                ...
                                // Start screens modules
                                function(done2) {
                                    self.logger.debug('Initialize screens modules ...');
                                    async.each(self.screenModules.values(), function(container, cb) {
                                       self.webServer.initializeScreen(container, cb);
                                    }, done2);
                                }
                            ], done);
                        },
