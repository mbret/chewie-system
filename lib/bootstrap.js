'use strict';
var runtime_profile_1 = require("./hooks/runtime-profile/runtime-profile");
var server_1 = require("./hooks/client-web-server/server");
...
var Bootstrap = (function () {
    ...
    Bootstrap.prototype.bootstrap = function (done) {
        // register hooks
        this.system.hooksToLoad.push(runtime_profile_1.RuntimeProfileHook);
        this.system.hooksToLoad.push(server_1.ClientWebServer);
        Promise
            .all([
