...
module.exports = function(system, logger, cb){
    ...
    async.series([
        ...
        function(done){
            ...
            system.orm.models.Modules = require(CORE_DIR + '/models/modules')(system.orm.sequelize, system);
            system.orm.models.User.hasMany(system.orm.models.Plugins);
            system.orm.models.Plugins.belongsTo(system.orm.models.User)
            system.orm.models.Plugins.hasMany(system.orm.models.Modules);
            system.orm.models.Modules.belongsTo(system.orm.models.Plugins);
            ...
            Promise
                .all([
                    ...
                    system.orm.models.Modules.sync({force: system.getConfig().database.connexion.dropOnStartup}),
                ])
                .then(function () {
