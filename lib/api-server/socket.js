...
module.exports = function(server, socketServer){
    ...
    socketServer.on('connection', function (socket) {
        ...
        server.daemon.userHandler.on('profile:stopped:completed', onProfileStoppedCompleted);
        server.daemon.userHandler.on('profile:started:completed', onProfileStartedCompleted);
        ...
        socket.on('disconnect', function(){
            ...
            server.daemon.userHandler.removeListener('profile:stopped:completed', onProfileStoppedCompleted);
            server.daemon.userHandler.removeListener('profile:started:completed', onProfileStartedCompleted);
        });
    });
};