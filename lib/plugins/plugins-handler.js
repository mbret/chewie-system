...
var PersistencePlugin = require(LIB_DIR + '/persistence/plugins-persistence.js');
...
var TaskTriggerContainer = require(LIB_DIR + '/plugins/task-triggers/task-trigger-container.js');
var TaskTriggerHelper = require(LIB_DIR + '/plugins/task-triggers/task-trigger-helper.js');
...
class PluginsHandler{
    ...
    registerTaskTrigger(pluginId, name, adapter, cb){
        ...
        // Extract user options
        PersistencePlugin.getUserOptions(pluginId, name, 'task-trigger', function(err, options){
            if(err){
                return cb(err);
            }
