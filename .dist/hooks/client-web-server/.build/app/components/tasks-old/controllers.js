(function(){
    ...
    function createTaskFromForm(formTask){
        ...
        var task = {
            outputAdapters: formTask.actions
    ...
    angular
        ...
        .controller('TasksController', function($rootScope, $scope, $http, APP_CONFIG, TASK_TYPE, notificationService, sharedApiService, tasksService, _, SweetAlert){
            ...
            sharedApiService.get('/tasks', {}).then(function(data){
                $scope.tasks = data;
        ...
        .controller('NewTaskController', function($scope, $http, $uibModal, APP_CONFIG, $log, tasksService, notificationService){
            ...
            $scope.addTriggerTask = function(size, module){
                var modalInstance = $uibModal.open({
                    ...
                    controller: function($scope, $uibModalInstance, module, $http, APP_CONFIG, sharedApiService, _){

                        $scope.taskTriggers = [];

                        // get triggers
                        sharedApiService.getTaskTriggers().then(function(results){
        ...
        .controller('ModalAddMovementTriggeredTask', function($scope, $uibModalInstance, module, tasksService){
            ...
            $scope.submitForm = function (form) {
                ...
                if ($scope.form.$valid) {
                    ...
                    var task = {
                        outputAdapters: $scope.task.actions
                            // Keep only checked
                            .filter(function(action){
                                return action.value;
                            })
