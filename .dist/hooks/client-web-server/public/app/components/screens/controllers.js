(function(){
    ...
    angular
        ...
        .controller('ScreensIndexController', function($scope, APP_CONFIG, $state, _, screensService, notificationService, googleApi, sharedApiService, util, auth, OAuth, $http){
